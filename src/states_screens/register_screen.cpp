...
void RegisterScreen::makeEntryFieldsVisible()
{
    ...
    getWidget<ButtonWidget >("password-reset")->setVisible(online && !new_account);
//    if (online && !new_account)
//    {
//        getWidget<ButtonWidget>("password-reset")->m_properties[GUIEngine::PROP_HEIGHT] = "100";
//    }
//    else
//    {
//        getWidget<ButtonWidget>("password-reset")->m_properties[GUIEngine::PROP_HEIGHT] = "0";
//    }
//    calculateLayout();
}   // makeEntryFieldsVisible
