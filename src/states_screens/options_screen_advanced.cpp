...
//  Copyright (C) 2009-2017 Marianne Gagnon, QwertyChouskie
//
...
DEFINE_SCREEN_SINGLETON( OptionsScreenAdvanced );

// -----------------------------------------------------------------------------

OptionsScreenAdvanced::OptionsScreenAdvanced() : Screen("options_advanced.stkgui")
{
    m_inited = false;
}   // OptionsScreenVideo
...
// -----------------------------------------------------------------------------
 ...
 void OptionsScreenAdvanced::loadedFromFile()
{
    /*m_inited = false;
    ...
    if (m_skins.size() == 0)
    {
        Log::warn("OptionsScreenAdvanced", "Could not find a single skin, make sure that "
...
void OptionsScreenAdvanced::init()
{
    Screen::init();
    RibbonWidget* ribbon = getWidget<RibbonWidget>("options_choice");
    assert(ribbon != NULL);
    ribbon->select( "tab_advanced", PLAYER_ID_GAME_MASTER );
    ...
    CheckBoxWidget* azdo = getWidget<CheckBoxWidget>("azdo");
    assert( azdo != NULL );
    ...
    if (!currSkinFound)
    {
        Log::warn("OptionsScreenAdvanced",
...
void OptionsScreenAdvanced::eventCallback(Widget* widget, const std::string& name, const int playerID)
{
    ...
    else if (name == "language")
    {
        ...
        OptionsScreenAdvanced::getInstance()->push();
    }*/
...
void OptionsScreenAdvanced::tearDown()
{
    Screen::tearDown();
...
void OptionsScreenAdvanced::unloaded()
{
    m_inited = false;
}   // unloaded
